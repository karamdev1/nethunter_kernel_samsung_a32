...
static int __init rtw_8723cs_driver_init(void)
{
	return sdio_register_driver(&rtw_8723cs_driver);
}
module_init(rtw_8723cs_driver_init);

static void __exit rtw_8723cs_driver_exit(void)
{
	sdio_unregister_driver(&rtw_8723cs_driver);
}
module_exit(rtw_8723cs_driver_exit);
